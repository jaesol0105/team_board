...
open class TaskAdapter (
    ...
    private fun alertDialogForDeleteList(position: Int, title: String) {
        ...
        builder.setMessage(context.getString(R.string.task_warning_message_delete_task))
        ...
        builder.setNegativeButton(context.getString(R.string.cancel)) { dialogInterface, which ->
            dialogInterface.dismiss()
        }
